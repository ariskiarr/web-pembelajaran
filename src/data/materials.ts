...
# Kamu bisa mencobanya di latihan untuk pemahaman lebih lanjut`,
    keyPoints: [
      ...
      "Dibuat oleh Guido van Rossum dan dinamai dari acara komedi Monty Python",
      "Python 3 adalah versi yang aktif dikembangkan (Python 2 sudah tidak didukung)",
      "Banyak digunakan untuk web development, data science, AI, dan automation",
      "Memiliki ekosistem library yang sangat kaya dan komunitas global yang besar",
      "Gratis, open source, dan cross-platform (Windows, Mac, Linux)",
    ],
    nextSteps: [
      ...
      "Jika mendapatkan kesulitan dalam memahami materi maka tanyakan kepada mentor kamu",
    ],
    relatedExercises: [],
  },
  {
...
print("20 - 8 =", 20 - 8)`,
    keyPoints: [
      ...
      'Komentar menggunakan # untuk satu baris, atau """ """ untuk multi-baris',
      "Komentar tidak akan dieksekusi oleh program, hanya untuk dokumentasi",
      "Tanda kutip tunggal ' dan ganda \" bisa digunakan untuk string",
      "Gunakan tanda koma untuk memisahkan item dalam print()",
      "Parameter sep= untuk mengubah pemisah, end= untuk mengubah akhiran",
    ],
    nextSteps: [
